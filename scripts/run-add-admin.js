...
process.env.GOOGLE_SHEET_ID = "1SBrudshivEUAGBdRFy_xBol-dk96u4DtMPyF0b0xRXw";
process.env.GOOGLE_CLIENT_EMAIL = "mens-fellowship-app@gideons-army-458021.iam.gserviceaccount.com";
...
// Import and run the add-admin script
import('./add-admin.js'); 